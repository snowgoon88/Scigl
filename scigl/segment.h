...
#   include <boost/shared_ptr.hpp>
    typedef boost::shared_ptr<class Segment> SegmentPtr;
#else
    typedef class Segment *                  SegmentPtr;
#endif


/**
 * Represententation of a list of segments.
 * A segment is drawn between each pair of points.
 *
 */
