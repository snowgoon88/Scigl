...
CORE_SRC_$(d)	:= $(d)/model.h $(d)/model.cc \
                   $(d)/logged_vector.cc $(d)/logged_vector.h \

CORE_OBJS_$(d)	:= $(d)/model.o \
                   $(d)/logged_vector.o \

CORE_DEPS_$(d)	:= $(CORE_OBJS_$(d):%=%.d)

TGTS_$(d)	:= $(d)/libmodel.a
...
$(CORE_OBJS_$(d)): 	CF_TGT := -I$(d) -I$(EIGEN_ROOT) -Iview\
                                  -Wno-deprecated
